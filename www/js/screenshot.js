...
function screenshot_with_property_panel() {
    ...
    var ViewerBlobURL = _viewer.getScreenShot();
     ...
     console.log(_viewer.getScreenShot());
     console.log(ViewerBlobURL);
     console.log(_viewer.container.offsetWidth);
     console.log(_viewer.container.offsetHeight);
    ...
    var view3DContainter = _viewer.container;
    ...
    tmpCanvas.width = w;
    tmpCanvas.height = h;
console.log(tmpCanvas.width);
console.log(tmpCanvas.height);
...
console.log('hi');
        ...
        html2canvas(propertyPanel, {
            onrendered: function(canvas) {
                ...
                //produce image blob
                var allBlobURL = window.URL.createObjectURL(dataURLToBlob(tmpCanvas.toDataURL("image/png")));
                //open the blob in a new page (optional)
                window.open(allBlobURL);
            }
        });
    };
}
